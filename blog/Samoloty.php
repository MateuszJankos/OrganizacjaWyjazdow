          ...
          <div class="col-lg-12">
            ...
            <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="departureDate" placeholder="Podaj datę wylotu">
              </div>
              <div class="form-group">
                <label for="returnDate">Data powrotu:</label>
                <input type="text" class="form-control" id="returnDate" placeholder="Podaj datę powrotu">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="destination" placeholder="Podaj miejsce docelowe">
              </div>
              <div class="form-group">
                <label for="passengerCount">Ilość osób:</label>
                <input type="number" class="form-control" id="passengerCount" placeholder="Podaj ilość osób">
              </div>
              <div class="form-group">
                <label>Klasa podróży:</label>
                <div class="form-check">
                  <input type="radio" class="form-check-input" id="firstClass" name="travelClass" value="firstClass">
                  <label class="form-check-label" for="firstClass">1 klasa</label>
                </div>
                <div class="form-check">
                  <input type="radio" class="form-check-input" id="businessClass" name="travelClass" value="businessClass">
                  <label class="form-check-label" for="businessClass">Klasa biznesowa</label>
                </div>
                <div class="form-check">
                  <input type="radio" class="form-check-input" id="economyClass" name="travelClass" value="economyClass">
                  <label class="form-check-label" for="economyClass">Klasa ekonomiczna</label>
                </div>
              </div>
              <button type="submit" class="btn btn-primary mt-3">Wyszukaj połączenia</button>
            </form>
            </div>
          </div>
        </div>
