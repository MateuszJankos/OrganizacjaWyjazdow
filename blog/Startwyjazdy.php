...
if (isset($_SESSION['userid'])) {
    ...
    // Pobranie wyjazdów powiązanych z użytkownikiem
    $tripsQuery = "SELECT wyjazd.ID_Wyjazdu, wyjazd.Data_Startu, wyjazd.Data_Konca FROM wyjazd
