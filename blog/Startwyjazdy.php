...
if (isset($_SESSION['userid'])) {
    ...
    $tripsQuery = "SELECT wyjazd.ID_Wyjazdu, wyjazd.Data_Startu, wyjazd.Data_Konca, grupa.Nazwa_Grupy, 
                          hotele.hotelNazwa AS Hotele, wiadomosc.Tresc AS Wiadomosc,
                          rezerwacja_hotelu.Data_start_rezerwacji, rezerwacja_hotelu.Data_koniec_rezerwacji
                   FROM wyjazd
                   ...
                   LEFT JOIN wiadomosc ON wyjazd.ID_Wyjazdu = wiadomosc.ID_Wyjazdu
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <?php if (!empty($trip['Hotele'])): ?>
                        ...
                        <?php endif; ?>
                    <?php if (!empty($trip['Wiadomosc'])): ?>
                        <p>Wiadomość: <?= htmlspecialchars($trip['Wiadomosc']) ?></p>
                    <?php endif; ?>
